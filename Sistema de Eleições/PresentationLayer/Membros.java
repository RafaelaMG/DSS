...
public  void preencheM(){
	...
	HashMap<Integer,String> flag;
        flag = FacadeB.membrosP(NrEleitorG);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("       Actuais Partidários");
        ...
        jButton1.setText("Adicionar novo Partidário");
        ...
        jButton3.setText("Remover Partidário");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.novo = new Novo();
        this.novo.setVisible(true); 
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        int nr = 0;
        HashMap<Integer,String> flag;
        flag = FacadeB.membrosP(this.getNrEleitor());
        for(Integer i : flag.keySet()){
        if(flag.get(i).equals(membros.getSelectedValue()))
               nr  = i;
                       }
        FacadeB.alterLider(nr,NrEleitorG);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        for(Integer i : flag.keySet()){
        if(flag.get(i).equals(membros.getSelectedValue())){
            j = membros.getSelectedIndex();
        System.out.println("index " + j + "lenght:"+membros.getComponents().length);
